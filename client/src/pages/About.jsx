...
export default function About() {
  return (
    <Container>
      <div className="py-20 px-4 max-w-4xl mx-auto text-slate-700 text-lg">
        <h1 className=" inline-block text-xl sm:font-semibold md:text-2xl lg:text-4xl md:font-extrabold  border  p-3 rounded-2xl shadow-sm shadow-teal-300 capitalize text-[#155e75] text-transparent bg-clip-text bg-gradient-to-r from-teal-800  to-yellow-500 border-yellow-100  my-5">
          About Real-listing
        </h1>
        <p className="mb-4 text-slate-700">
          Real-listing is a leading real estate agency that specializes in
