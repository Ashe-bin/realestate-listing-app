...
const navigationMenuTriggerStyle = cva(
  "group border-black/30   lg:rounded-xl inline-flex gap-4 h-10 w-max items-center justify-center  pr-4 pl-2 py-2 text-sm font-medium transition-colors  hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 hover:bg-[#fee9e1] active:bg-[#c0fdfb] "
);
